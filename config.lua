...
Config.PhoneApplications = {
    ...
    ["meos"] = {
        ...
        tooltipText = "MEOS",
        job = false,
        blockedjobs = {"hotdog", "mechanic", "ems", "ems1", "ems2", "ems2", "ems3" ,"ems4", "ems5", "ems6","ems7", "ems8", "cardealer", "lawyer", "realestate", "unemployed", "judge", "taxi", "trucker", "tow", "reporter", "garbage"},
        slot = 12,
        Alerts = 0,
    },
    ["lawyers"] = {
